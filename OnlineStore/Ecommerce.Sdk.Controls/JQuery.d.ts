...
interface JQuery {
    ...
    addClass(className: string, duration?: number, easing?: string, complete?: Function): JQuery;
    addClass(className: string, duration?: string, easing?: string, complete?: Function): JQuery;
    addClass(className: string, aswitch?: boolean, duration?: number, easing?: string, complete?: Function): JQuery;
    addClass(className: string, aswitch?: boolean, duration?: string, easing?: string, complete?: Function): JQuery;
    ...
    removeClass(className: string, duration?: number, easing?: string, complete?: Function): JQuery;
    removeClass(className: string, duration?: string, easing?: string, complete?: Function): JQuery;
    removeClass(className: string, aswitch?: boolean, duration?: number, easing?: string, complete?: Function): JQuery;
    removeClass(className: string, aswitch?: boolean, duration?: string, easing?: string, complete?: Function): JQuery;
