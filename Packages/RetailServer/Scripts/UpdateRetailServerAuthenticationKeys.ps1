...
foreach ($certificate in $certificates)
{
    ...
    Write-Host "Adding information for certificate with thumbprint '$certificateThumbprint' to the Certs.json file."
	...
	# TODO [rassadi] to [rassadi]: Retrieve all the fields below from the actual certificate (e.g. kty, alg).
	$certificateElement = (New-Object PSObject |
		...
		Add-Member -PassThru NoteProperty kid $certificateThumbprint |
...
{
   throw "Could not find the Certs.json file $retailServerCertFilePath"
}
...
Write-Host "Updating retail server web.config with correct certificate thumbprint ..."
$retailServerWebConfigPath = (Join-Path $RetailServerDeploymentPath 'web.config')
if ((Test-Path $retailServerWebConfigPath) -eq $false)
{
   throw "Could not find the web.config file $retailServerWebConfigPath"
}
...
# MIId3QYJKoZIhvcNAQcCoIIdzjCCHcoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUp36njreYiKY+lYfvpyzVjTKU
# Y/6gghhkMIIEwzCCA6ugAwIBAgITMwAAAJmqxYGfjKJ9igAAAAAAmTANBgkqhkiG
...
# bWrJUnMTDXpQzTGCBOMwggTfAgEBMIGVMH4xCzAJBgNVBAYTAlVTMRMwEQYDVQQI
# EwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3Nv
# ZnQgQ29ycG9yYXRpb24xKDAmBgNVBAMTH01pY3Jvc29mdCBDb2RlIFNpZ25pbmcg
# UENBIDIwMTECEzMAAABkR4SUhttBGTgAAAAAAGQwCQYFKw4DAhoFAKCB9zAZBgkq
# hkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAcBgorBgEEAYI3AgELMQ4wDAYKKwYBBAGC
# NwIBFTAjBgkqhkiG9w0BCQQxFgQURpZZytHT0LC/QHmlgfJcm+wfiRAwgZYGCisG
# AQQBgjcCAQwxgYcwgYSgUoBQAFUAcABkAGEAdABlAFIAZQB0AGEAaQBsAFMAZQBy
# AHYAZQByAEEAdQB0AGgAZQBuAHQAaQBjAGEAdABpAG8AbgBLAGUAeQBzAC4AcABz
# ADGhLoAsaHR0cDovL3d3dy5NaWNyb3NvZnQuY29tL01pY3Jvc29mdER5bmFtaWNz
# LyAwDQYJKoZIhvcNAQEBBQAEggEAAGjDRoVZwPR/qHiF6J/+4Y6lFdbXIrkpq8g9
# QW819J3xOm0SHqHsCtmKTXtOlnUi7zolX/oU8Pdof3qcFmkI1aBL2dHyHU+SAZRE
# dtMxcQJPtrPQLzRAghzyZdHXpVLisQqP9Mer9qm8WsG2l0Jr8DvfuQtYqv4UVJIZ
# llwG8DBzfYWiTuWn5wZppMXy3qbxBYcAHmckz9Ak5GXsyZzfhUIr9jeXVuG/qM/j
# k8KsjNuubfirDIcbG4QOi0ONxLSezfqdqfvmEh5Tn/kG5KbowNufvkyQ7QixzZOl
# dgo93IdrCPM5ZiP26JsriaycR0YJje8YgTbuKfcnZaRwp1S3G6GCAigwggIkBgkq
...
# EzMAAACZqsWBn4yifYoAAAAAAJkwCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzEL
# BgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDgwNjA4NTMwOFowIwYJKoZI
# hvcNAQkEMRYEFFgP6KyIGic2j/RUJVCNBXcVW58fMA0GCSqGSIb3DQEBBQUABIIB
# AAMrsaw9G5QavfbpTeCm5n2ca/9w32HP/FGdYsRKkesJZYAMu7KXB1iB45MUojov
# mk2XAYwfr+t0o5YSTQtVM20uy6QNagQ3hHU/MXdAAPdaqREbPGI6TNoyyeK1wLgW
# Ke9eV59TYXJanQqejTWZKd3RCrWUVR00yEAzxHJ0omJY3Xat34+DhIAY1yUWI/Rf
# QycBiihLG2WmtF51773ckkUI1fGWGJBfqOfvPc5pH3wii2HA561nG4SRu2FIRXch
# k7x3VmYR94LEjut2aam5kzVJVcT8vjQBFdbhzrOvRNs2JLxGoOHQWbUJPrNFPfcH
# KSHURMt6Z2H/1C25jK/QLac=
