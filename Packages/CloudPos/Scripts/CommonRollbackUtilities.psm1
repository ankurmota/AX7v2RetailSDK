	...
	[string] $folderExcluded)
{
    ...
    if($filetypesExcluded -ne $null)
	{
		if($filetypesExcluded -ne "")
		{
	 		$argumentList = $argumentList + " -x!$filetypesExcluded"
		}
	}
    
    if($folderExcluded -ne $null)
	{
		if($folderExcluded -ne "")
		{
    ...
    {
        throw "fail to generate zip archive: $destFile"
    }
}
...
{
	# 'AosService' website is deployed for service model deployments.
	$websitePath = Get-WebSitePhysicalPath -Name 'AosService'

	if([string]::IsNullOrWhiteSpace($websitePath))
	{
		# 'AosWebApplication' website is deployed for local VHD deployments.
		$websitePath = Get-WebSitePhysicalPath -Name 'AosWebApplication'
	}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdAlaw4FbAqd0euUeONRQVmPk
# KNegghhkMIIEwzCCA6ugAwIBAgITMwAAAKxjFufjRlWzHAAAAAAArDANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU2jVXtGrqS/2PlNlvcfvLwoHfnEowfAYKKwYB
# BAGCNwIBDDFuMGygOoA4AEMAbwBtAG0AbwBuAFIAbwBsAGwAYgBhAGMAawBVAHQA
# aQBsAGkAdABpAGUAcwAuAHAAcwBtADGhLoAsaHR0cDovL3d3dy5NaWNyb3NvZnQu
# Y29tL01pY3Jvc29mdER5bmFtaWNzLyAwDQYJKoZIhvcNAQEBBQAEggEAabDLvVHS
# pkVLMAMwimAQogJ/blgYXyLkjVEMKTxhKBaG1VglC+x0j48ueFuKWY0E+fjacAOg
# 0hCR3aLmpmbYnztIglsXnTTGxzEMw9gPMTjVI+pYf1AnGKSi0P3NIab5+ZMLIBmJ
# 0l/a+MsVjQ5NzkXzHonREN5cgXE6QQW2H1nnFqB5cHwbvMkyM5TTmx8+G7jRHLFm
# KZcpH6U/51/zB2pfhNV+G7JqE1p+PbOmb1+x5gKXdPfrRFbaR1aF+/sw5uGphV3R
# KtfLqKJ7L2sYCu0rbiEIujaMhJ6i71J2ikOZt0iRyJCiLpTw+UstZmzgVI41aWQk
# 1rEW6k4yf78A1aGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQsw
# CQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9u
# ZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSEwHwYDVQQDExhNaWNy
# b3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAACsYxbn40ZVsxwAAAAAAKwwCQYFKw4D
# AhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTE2MDcyMTIxMDcyMFowIwYJKoZIhvcNAQkEMRYEFBhSuaAjod7BYawcVfAcTlQn
# GLXAMA0GCSqGSIb3DQEBBQUABIIBAInJ2xpLmJW11y4fmT/eDdWoQJLUW0PBY1Cf
# jIcnFRH2zROShA+zPfV9ejK9/dpq69GHdaBrI63rcwThK8JQvWwdyrcO1JRu7pfm
# pICKo90j+U3Ezz+Aah+Q6M2hTz/axVmeX326TtljTLWxvaiPafnZRmQ8vXDrX8qB
# OxSgplbvYdx4DnvOn2IiM/kflKdAzXnlzFj8nhssfLo8NuijoJ7n8ExkoiuZzbcT
# BljpZVfejd+dBhudpMTcwkd5veGJXgKCcomEnYD+w5rJyKoI0gLhQdZnrIoP60uN
# KpILVpcT1cYS5N8JpjlDpJOoIAb+Pbc2JV01OBcRqCjyh1sXM1w=
