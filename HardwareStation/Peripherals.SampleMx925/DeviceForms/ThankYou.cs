...
namespace Contoso
{
    namespace Commerce.HardwareStation.Peripherals.PaymentTerminal.SampleMX925.DeviceForms
    {
        ...
        /// <summary>
        ///  Device form for displaying thank you screen.
        /// </summary>
        [Export("THANKYOU", typeof(IForm))]
        public class ThankYou : IForm
        {
            private const int ThankYouTextControlId = 2;
