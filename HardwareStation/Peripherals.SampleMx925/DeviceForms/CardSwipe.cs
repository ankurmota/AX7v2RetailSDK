...
namespace Contoso
{
    namespace Commerce.HardwareStation.Peripherals.PaymentTerminal.SampleMX925.DeviceForms
    {
        ...
        /// <summary>
        ///  Device form for displaying card swipe screen.
        /// </summary>
        [Export("CARDSWIPE", typeof(IForm))]
        public class CardSwipe : IForm
        {
            private const int SwipeTextControlId = 2;
