...
namespace Contoso
{
    namespace Commerce.HardwareStation.Peripherals.PaymentTerminal.SampleMX925.DeviceForms
    {
        ...
        /// <summary>
        ///  Device form for displaying welcome screen.
        /// </summary>
        [Export("WELCOME", typeof(IForm))]
        public class Welcome : IForm
        {
            private const int WelcomeTextControlId = 2;
