    ...
    export module Graphics {
        export module Display {
            ...
            export class DisplayProperties {
                ...
                static removeEventListener(eventName: string, handler: any);
            }
        }
    }
}
    ...
    export module Devices {
        export module PointOfService {
            ...
            export class MagneticStripeReader {
                static getDeviceSelector(): string;
                static fromIdAsync<T>(deviceId: string): Windows.Foundation.IPromise<T>;
                static getDefaultAsync<T>(): Windows.Foundation.IPromise<T>;
                claimReaderAsync<T>(): Windows.Foundation.IPromise<T>;
            }

            export interface ClaimedMagneticStripeReader {
                isDecodeDataEnabled: boolean;
                tracksToRead: MagneticStripeReaderTrackIds;
                onbankcarddatareceived: any;
                enableAsync<T>(): Windows.Foundation.IPromise<T>;
                close();
            }
            ...
            export class BarcodeScanner {
                ...
                static fromIdAsync<T>(deviceId: string): Windows.Foundation.IPromise<T>;
                static getDefaultAsync<T>(): Windows.Foundation.IPromise<T>;
                claimScannerAsync<T>(): Windows.Foundation.IPromise<T>;
            }

            export interface ClaimedBarcodeScanner {
                isDecodeDataEnabled: boolean;
                ondatareceived: any;
                enableAsync<T>(): Windows.Foundation.IPromise<T>;
                close();
        ...
        export module Bluetooth {
            ...
            export module Rfcomm {
                export class RfcommServiceId {
                    ...
                    static fromUuid(any): RfcommServiceId;
                }
                export class RfcommDeviceService {
                   ...
                   getSdpRawAttributesAsync<T>(): Windows.Foundation.IPromise<T>;
                   getSdpRawAttributesAsync<T>(cacheMode: Windows.Devices.Bluetooth.BluetoothCacheMode): Windows.Foundation.IPromise<T>;
               }
           }
        }
    }
    ...
    export module UI {
        export module ViewManagement {
            ...
            export class ApplicationView {
                ...
                static getForCurrentView(): Windows.UI.ViewManagement.ApplicationViewState;
            }
