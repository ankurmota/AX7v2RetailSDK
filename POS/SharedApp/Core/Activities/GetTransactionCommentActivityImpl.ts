...
module Commerce.Activities {
    ...
    GetTransactionCommentActivity.prototype.execute = function (): IVoidAsyncResult {
        var self = <GetTransactionCommentActivity>(this);
        ...
        asyncQueue
            .enqueue(() => {
                ...
                textInputDialog.show({ content: self.context.cart.Comment, maxLength: 60 }, false /* hideOnResult */)
