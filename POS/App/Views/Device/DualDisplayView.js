(function () {
    ...
    /**
     * Setup view when activated
     */
    app.onactivated = function (args) {
        if (args.detail.kind === Windows.ApplicationModel.Activation.ActivationKind.launch) {
            // Let main view know when secondary (this) view is closed
            secondaryView = Windows.UI.ViewManagement.ApplicationView.getForCurrentView();
            secondaryView.onconsolidated = function () {
                sendCloseMessage();
            }

            // Set up messaging between this view and main view
    ...
    /**
     * Sends message to main view to announce that this view has closed
     */
    function sendCloseMessage() {
        var message = { type: "close" };
        opener.postMessage(JSON.stringify(message), document.location.protocol + "//" + document.location.host);
    }

    /**
     * Handles messages received from the main view
     * Specifically, retrieves and displays the updated cart information
     */
    function handleMessage(message) {
        ...
        switch (data.type) {
            ...
            case "displayTransaction":
                displayTransaction(args);
                break;
        }
    }

    function initialize(deviceConfiguration) {
        Commerce.CSSHelpers.cssFileRootPath = "/"; // absolute path to the package root.
        Commerce.CSSHelpers.applyThemeAsync(deviceConfiguration);
    }

    function displayTransaction(cart) {
        // Show current amount due for transaction
        var amountDue = cart.AmountDue || 0;
        document.getElementById("amountDue").innerText = amountDue;
    }
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFMtCQmLko5RM
// SIG // ZURME0NMX+7FcaQ+oIIYZDCCBMMwggOroAMCAQICEzMA
...
// SIG // hvcNAQkEMRYEFOphHas5ADfyT0ykMnccdOWop6jlMGgG
// SIG // CisGAQQBgjcCAQwxWjBYoCaAJABEAHUAYQBsAEQAaQBz
// SIG // AHAAbABhAHkAVgBpAGUAdwAuAGoAc6EugCxodHRwOi8v
// SIG // d3d3Lk1pY3Jvc29mdC5jb20vTWljcm9zb2Z0RHluYW1p
// SIG // Y3MvIDANBgkqhkiG9w0BAQEFAASCAQAyo/5BvKzZNvd+
// SIG // TKJDHdNtaBDoqpfpkGrll8ngKM/jn+tDVjJuO68vXPsz
// SIG // rlVOitz7LrcW/ktNDQjCSX6Qk+16OvyIsBKcDSw2xsC4
// SIG // RRQQFHRlXR2F2hCMeoHK97D4zi9dfDvHVWNOKJC/AC+p
// SIG // PdtJ/XkTkLap9KMfSUZD96ADP/mWxb3zQolP5f3hvb0S
// SIG // G0Widyy1x8JlzH48r+oO4oBGIlh1+1aQUaixV5/kkH4A
// SIG // 2D3H1JUQOVwDioia3Ngv1DkTET2AlnYMVsNsN4/UatL9
// SIG // ULzfjjuBl7tFY4k3eKajQPYl3JxRbvYc+LGn4rzjtvbB
// SIG // sbOOClCObeswSrCTHKqkoYICKDCCAiQGCSqGSIb3DQEJ
// SIG // BjGCAhUwggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVTMRMw
// SIG // EQYDVQQIEwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRt
// SIG // b25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRp
// SIG // b24xITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0YW1w
// SIG // IFBDQQITMwAAAJzu/hRVqV01UAAAAAAAnDAJBgUrDgMC
// SIG // GgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAc
// SIG // BgkqhkiG9w0BCQUxDxcNMTYwNzIxMjEwNzEwWjAjBgkq
// SIG // hkiG9w0BCQQxFgQU6l9fO4Rggj8yaLtl/iSec9l829gw
// SIG // DQYJKoZIhvcNAQEFBQAEggEACJhdNr6IgPP8ltAp0La3
// SIG // 8PRQvfZ0Zuvoa4IQWvOH/sye9jwxqN344a4Whpx45JlI
// SIG // V7w8pPbRSWvjX9WTAYkEWq1p12UJvrZF9IF9Y+FojmxG
// SIG // xfM7ZRTJ6dqkc6J7nlf6587rQADC5bNXVLdfciCm1csw
// SIG // 180qFayimtAOFlEjdDDM8ZJ1RM//qrvMDD1Oiht4K+PY
// SIG // ofRUUKNl4lV+fN2OhvL4UteIY3tOSg3WW/Bom297UXH4
// SIG // CybFe8yY8XhP7nP6KNzMqh9+HeLlnQe4aNPxYBX79Zex
// SIG // 6heNpfXmu5HkHznNP9LxGwLCv5YrdnA4BBGuQ/te2isz
// SIG // wBcii7AX2txPLQ==
