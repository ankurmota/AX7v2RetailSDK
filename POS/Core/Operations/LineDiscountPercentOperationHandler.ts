...
module Commerce.Operations {
    ...
    /**
     * Operation handler for applying a line discount percentage.
     */
    export class LineDiscountPercentOperationHandler extends OperationHandlerBase {
        /**
         * Executes the LineDiscountPercent operation.
         *
        ...
        public execute(options: ILineDiscountOperationOptions): IAsyncResult<IOperationResult> {
            return DiscountOperationsHelper.createLineDiscountQueue(options, /* isPercent */ true).run();
        }
    }
}