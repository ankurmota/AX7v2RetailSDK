...
module Commerce.Operations {
    ...
    /**
     * Operation handler for applying a total discount amount.
     */
    export class TotalDiscountAmountOperationHandler extends OperationHandlerBase {
        /**
         * Executes the TotaloDiscountAmount operation.
         *
        ...
        public execute(options: ITransactionDiscountOperationOptions): IAsyncResult<IOperationResult> {
            return DiscountOperationsHelper.createTransactionDiscountQueue(options, /* isPercent */ false).run();
        }
    }
}