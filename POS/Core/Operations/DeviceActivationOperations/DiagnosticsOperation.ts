...
module Commerce.Operations {
    ...
    export class DiagnosticsOperation extends DeviceActivationOperationBase {
        ...
        public operationName(): string {
            return Helpers.DeviceActivationHelper.DIAGNOSTICS_OPERATION_NAME;
        }
        ...
        public processingStatusName(): string {
            return ViewModelAdapter.getResourceString("string_8081");
        }
        ...
        public errorStatusName(): string {
            return ViewModelAdapter.getResourceString("string_8082");
        }
        ...
        public operationProcess(): () => IVoidAsyncResult {
            return () => {
                ...
                // Currently, setting the tenant information used for diagnostics purposes only
                // works with the AAD Adator as the tenant information would otherwise not be available.
                Host.instance.azureActiveDirectoryAdapter.login().done((user: Host.IUserDetails): void => {
                    ApplicationStorage.setItem(ApplicationStorageIDs.TENANT_ID, user.tenantId);
                    TsLogging.LoggerBase.setTenantInfo(user.tenantId);
                    asyncResult.resolve();
                });
