...
module Commerce.Operations {
    ...
    export class GetPaymentMerchantInformationOperation extends DeviceActivationOperationBase {
        ...
        public operationName(): string {
            return Helpers.DeviceActivationHelper.GET_PAYMENT_MERCHANT_INFORMATION_OPERATION_NAME;
        }
        ...
        public processingStatusName(): string {
            return ViewModelAdapter.getResourceString("string_8083");
        }
        ...
        public errorStatusName(): string {
            return ViewModelAdapter.getResourceString("string_8084");
        }
        ...
        public operationProcess(): () => IVoidAsyncResult {
            return (() => {
                return new Activities.SaveMerchantInformationActivity(this.stateOperation.hardwareProfile).execute();
            }).bind(this);
        }
    }
}