...
namespace Contoso
{
    namespace Commerce.Runtime.DataServices.Common
    {
        ...
        /// </summary>
        public class HealthCheckDataService : IRequestHandler
        {
            /// <summary>
            ...
            {
                get { return new[] { typeof(RunDBHealthCheckDataRequest) }; }
            }
            ...
            public Response Execute(Request request)
            {
                ...
                if (requestType == typeof(RunDBHealthCheckDataRequest))
                {
                    response = this.RunDBHealthCheck((RunDBHealthCheckDataRequest)request);
                }
                else
                {
