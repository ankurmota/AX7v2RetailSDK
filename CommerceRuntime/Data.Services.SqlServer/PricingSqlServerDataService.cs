...
namespace Contoso
{
    namespace Commerce.Runtime.DataServices.SqlServer
    {
        ...
        /// </summary>
        public class PricingSqlServerDataService : IRequestHandler
        {
            /// <summary>
            ...
            private EntityDataServiceResponse<PriceGroup> GetAffiliationPriceGroups(EntityDataServiceRequest<IEnumerable<AffiliationLoyaltyTier>, PriceGroup> request)
            {
                ...
                var affiliationPriceGroups = pricingSqlDataManager.GetAffiliationPriceGroups(request.RequestParameter, QueryResultSettings.AllRecords);
