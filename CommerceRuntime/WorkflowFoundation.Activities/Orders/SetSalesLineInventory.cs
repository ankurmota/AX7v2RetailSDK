...
namespace Contoso
{
    namespace Commerce.Runtime.WorkflowFoundation.Activities
    {
        ...
        /// <summary>
        /// Activity that sets inventory for sales lines.
        /// </summary>
        public sealed class SetSalesLineInventory : CodeActivity
        {
            /// <summary>
            ...
            protected override void Execute(CodeActivityContext context)
            {
                ...
                ItemAvailabilityHelper.SetSalesLineInventory(requestContext, transaction);
            }
        }
    }
}
