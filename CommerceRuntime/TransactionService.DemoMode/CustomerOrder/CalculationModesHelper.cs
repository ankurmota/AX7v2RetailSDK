...
namespace Contoso
{
    namespace Commerce.Runtime.Services.CustomerOrder
    {
        ...
        /// </summary>
        internal class CalculationModesHelper
        {
            /// <summary>
            ...
            public static GetCustomerOrderCalculationModesServiceResponse GetCalculationModes(
                GetCustomerOrderCalculationModesServiceRequest request)
            {
