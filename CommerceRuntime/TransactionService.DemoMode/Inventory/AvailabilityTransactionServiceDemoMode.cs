...
namespace Contoso
{
    namespace Commerce.Runtime.Services
    {
        ...
        /// <summary>
        /// Availability demo mode transaction service.
        /// </summary>
        public class AvailabilityTransactionServiceDemoMode : IRequestHandler
        {
            /// <summary>
            ...
            private static EntityDataServiceResponse<ItemAvailabilityStore> GetStoreAvailability()
            {
                throw new FeatureNotSupportedException(FeatureNotSupportedErrors.Microsoft_Dynamics_Commerce_Runtime_DemoModeOperationNotSupported, "GetStoreAvailability is not supported in demo mode.");
            }
        }
    }
}
