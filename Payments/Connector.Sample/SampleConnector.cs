...
namespace Contoso
{
    namespace Retail.SampleConnector.Portable
    {
        ...
        public class SampleConnector : SampleProcessorIdentifier, IPaymentProcessor, IPaymentProcessorExtension
        {
            #region Contants
            ...
            private const string PaymentAcceptBaseAddressONEBOX = @"http://localhost:3973";
        ...
        private const string DefaultEnvironment = "INT";
            ...
            public Response Authorize(Request request, PaymentProperty[] requiredInteractionProperties)
            {
                ...
                PaymentUtilities.LogOperationResult(methodName, this.Name, Platform, request, response);
            ...
            public Response Void(Request request)
            {
                ...
                ProcessVoidResult(voidResponse, voidRequest, errors);
            ...
            public Response GetMerchantAccountPropertyMetadata(Request request)
            {
                ...
                property = new PaymentProperty(
                    ...
                    TestData.TestString);
                property.SetMetadata("Test String:", "The TestString received from Microsoft Test Provider", false, false, 7);
                properties.Add(property);
                property = new PaymentProperty(
                    GenericNamespace.MerchantAccount,
                    SampleMerchantAccountProperty.TestDecimal,
                    TestData.TestDecimal);
                property.SetMetadata("Test Decimal:", "The TestDecimal received from Microsoft Test Provider", false, false, 8);
                properties.Add(property);
                property = new PaymentProperty(
                    GenericNamespace.MerchantAccount,
                    SampleMerchantAccountProperty.TestDate,
                    TestData.TestDate);
                property.SetMetadata("Test Date:", "The TestDate received from Microsoft Test Provider", false, false, 9);
                properties.Add(property);
            ...
            private static void ValidateMerchantProperties(RequestBase requestBase, List<PaymentError> errors)
            {
                ...
                */
                ...
                if (!TestData.TestString.Equals(requestBase.TestString))
                {
                ...
                if (TestData.TestDecimal != requestBase.TestDecimal)
                {
                ...
                if (TestData.TestDate != requestBase.TestDate)
                {
                ...
                */
                switch (string.Format("{0:0.00}", request.Amount))
                {
                    ...
                    case TestData.AuthorizationPartialAuthorization:
                        ...
                        {
                            SetAuthorizationResult(response, request.Amount.Value - 0.05M, AuthorizationResult.PartialAuthorization, "Partial Approval", AVSResult.Returned, AVSDetail.BillingAddress, errors, ErrorCode.None);
                        }
                        else
                        {
            ...
            private static bool ProcessVoidResult(VoidResponse response, VoidRequest request, IList<PaymentError> errors)
            {
                /* 
                 IMPORTANT!!!
                 THIS IS SAMPLE CODE ONLY!  
